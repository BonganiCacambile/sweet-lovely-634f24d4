...
export const MENU_ITEMS: MenuItem[] = [
  // Pizza
  { id: "cheese-avalanche", category: "pizza", title: "Cheese Avalanche", price: "R14.99", allergens: "Dairy, Gluten", nutrition: "Calories: 340 · Fat: 18g · Carbs: 29g · Protein: 16g", content: "Mozzarella, cheddar, Parmesan, gouda, ricotta, marinara sauce, oregano", image: fr("Q4djsExkm2dVJLND8pnRkbmHKy8.png"), portion: "from" },
  { id: "buffalo-bliss", category: "pizza", title: "Buffalo Bliss", price: "R15.99", allergens: "Dairy, Gluten, Eggs", nutrition: "Calories: 310 · Fat: 15g · Carbs: 28g · Protein: 14g", content: "Buffalo chicken, blue cheese crumbles, mozzarella, ranch dressing, red onions", image: fr("fOcW4cqVIKe7O6jovEeqZ46Cg.png"), portion: "from" },
  { id: "mediterranean-marvel", category: "pizza", title: "Mediterranean Marvel", price: "R15.99", allergens: "Dairy, Gluten", nutrition: "Calories: 260 · Fat: 12g · Carbs: 27g · Protein: 11g", content: "Feta, Kalamata olives, red onions, sun-dried tomatoes, spinach, mozzarella, olive oil, oregano", image: fr("vtNegrYfppnZJV5SpQd607Hls8.png"), portion: "from" },
  { id: "hawaiian-heatwave", category: "pizza", title: "Hawaiian Heatwave", price: "R14.99", allergens: "Dairy, Gluten", nutrition: "Calories: 270 · Fat: 11g · Carbs: 30g · Protein: 12g", content: "Grilled pineapple, Canadian bacon, mozzarella, marinara sauce, jalapeños", image: fr("z0tpcmuGY42myUTNyLF9LCXg.png"), portion: "from" },
  { id: "meat-lovers", category: "pizza", title: "Meat Lover's Feast", price: "R16.99", allergens: "Dairy, Gluten", nutrition: "Calories: 350 · Fat: 19g · Carbs: 29g · Protein: 18g", content: "Pepperoni, Italian sausage, bacon, ham, mozzarella, marinara sauce", image: fr("ilD3FzfskejkXM7jRyVgKSBEE5I.png"), portion: "from" },
  { id: "garden-delight", category: "pizza", title: "Garden Delight", price: "R13.99", allergens: "Dairy, Gluten, Nuts", nutrition: "Calories: 240 · Fat: 11g · Carbs: 27g · Protein: 10g", content: "Zucchini, bell peppers, cherry tomatoes, spinach, red onions, mozzarella, pesto sauce", image: fr("Jo0m3edxzWNVUCgzB4ukskOgTHw.png"), portion: "from" },
  { id: "pepperoni-popper", category: "pizza", title: "Pepperoni Popper", price: "R14.99", allergens: "Dairy, Gluten", nutrition: "Calories: 320 · Fat: 17g · Carbs: 29g · Protein: 14g", content: "Double pepperoni, mozzarella, spicy marinara sauce, crushed red pepper, black olives", image: fr("bo5PFGtg1mLU0lWO3J9CWKVAcM.png"), portion: "from" },
  { id: "truffle-temptation", category: "pizza", title: "Truffle Temptation", price: "R16.99", allergens: "Dairy, Gluten", nutrition: "Calories: 300 · Fat: 15g · Carbs: 28g · Protein: 12g", content: "Truffle oil, wild mushrooms, mozzarella, Parmesan, arugula, garlic cream sauce", image: fr("EvzWDEqJkdunx7f5YzmUVnArM4.png"), portion: "from" },
  { id: "bbq-blaze", category: "pizza", title: "BBQ Blaze", price: "R15.99", allergens: "Dairy, Gluten", nutrition: "Calories: 290 · Fat: 12g · Carbs: 29g · Protein: 15g", content: "Grilled chicken, red onions, smoky BBQ sauce, cheddar, mozzarella, cilantro", image: fr("dQKnVrygQTPBTqZDioB8akNs.png"), portion: "from" },
  { id: "garlic-supreme", category: "pizza", title: "Garlic Supreme", price: "R13.99", allergens: "Dairy, Gluten", nutrition: "Calories: 270 · Fat: 13g · Carbs: 27g · Protein: 11g", content: "Roasted garlic, caramelized onions, mozzarella, Parmesan, Alfredo, fresh parsley", image: fr("Q2rEr3IGpX893CKsEuhm5IGMKk.png"), portion: "from" },
  { id: "margarita-muse", category: "pizza", title: "Margarita Muse", price: "R12.99", allergens: "Dairy, Gluten", nutrition: "Calories: 220 · Fat: 10g · Carbs: 26g · Protein: 9g", content: "Fresh mozzarella, ripe tomatoes, basil, EVOO, sea salt, marinara sauce", image: fr("O35ad4eRtufs0gpp6JZXayT5IM.png"), portion: "from" },
  { id: "firecracker-inferno", category: "pizza", title: "Firecracker Inferno", price: "R14.99", allergens: "Dairy, Gluten", nutrition: "Calories: 280 · Fat: 14g · Carbs: 28g · Protein: 12g", content: "Spicy pepperoni, jalapeños, crushed red pepper, mozzarella, marinara, sriracha drizzle", image: fr("lp6wNgrYu7ClOrMG4ibaVQNDWLo.png"), portion: "from" },
  // Pasta
